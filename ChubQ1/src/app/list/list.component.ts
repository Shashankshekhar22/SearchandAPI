...
export class ListComponent implements OnInit {
  ...
  ngOnInit() {
    this.service.currentVegetableName.subscribe((name) => {
      if (name === "") {
        this.vegetables = this.searchVegetablesList;
        return;
      }
      const searchVeigetable = this.vegetables.filter((vegitableList) => {
        return vegitableList.toLowerCase().match(name.toLowerCase());
      });
      this.vegetables = searchVeigetable;
